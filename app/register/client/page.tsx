...
const PERKS = [
  { icon: '📋', text: 'Programmes d\'entraînement 100% personnalisés' },
  { icon: '🥗', text: 'Plan nutritionnel avec macros sur-mesure' },
  { icon: '⏱️', text: 'Protocoles de jeûne intermittent adaptés' },
  { icon: '💡', text: 'Conseils lifestyle de votre coach' },
  { icon: '📊', text: 'Suivi de votre progression semaine après semaine' },
];
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'users', cred.user.uid), {
        email, name: name.trim(), role: 'client', createdAt: new Date().toISOString(),
      });
      ...
      <div className="rc-left">
        ...
        <div className="rc-left-content" style={{ opacity: mounted ? 1 : 0, transform: mounted ? 'none' : 'translateY(24px)', transition: 'opacity .7s ease .1s, transform .7s ease .1s' }}>
          ...
          <h1 className="rc-headline">
            Commencez votre<br />
            <span className="rc-accent">transformation.</span>
          </h1>

          <p className="rc-sub">
            Rejoignez des milliers de personnes qui ont transformé leur corps et leur vie grâce à un coaching personnalisé de qualité.
          </p>
          ...
          {/* Testimonial */}
          <div className="rc-testimonial">
            <div className="rc-stars">{'★★★★★'}</div>
            <p className="rc-quote">
              "En 12 semaines, j'ai perdu 8kg et gagné en énergie. Le suivi personnalisé de mon coach a tout changé."
            </p>
        ...
        <div className="rc-form-wrap" style={{ opacity: mounted ? 1 : 0, transform: mounted ? 'none' : 'translateY(20px)', transition: 'opacity .65s ease .2s, transform .65s ease .2s' }}>
          ...
          <div className="rc-card">
            <div className="rc-card-header">
              <h2 className="rc-card-title">Créer mon compte</h2>
              <p className="rc-card-sub">Votre coach vous assignera un programme dès votre inscription</p>
            </div>
            ...
            <div className="rc-footer-links">
              ...
              <p>
                Vous êtes coach ?{' '}
                <span className="rc-link rc-link-dim" onClick={() => router.push('/register/coach')}>Créer un espace coach</span>
              </p>
            </div>
          </div>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rc-ov-crimson {
          ...
          width: 65%;
          height: 65%;
          background: radial-gradient(circle, rgba(158,27,27,.22) 0%, transparent 70%);
          z-index: 3;
          pointer-events: none;
        }
        .rc-left-content {
        ...
        @media (max-width: 768px) {
          ...
          .rc-left { width: 100%; height: 260px; flex-shrink: 0; }
          .rc-left-content { padding: 0 24px 24px; }
          .rc-perks { display: none; }
          .rc-testimonial { display: none; }
          .rc-sub { display: none; }
